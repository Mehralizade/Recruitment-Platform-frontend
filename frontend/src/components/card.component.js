...
export default class Card extends Component {
    constructor(props){
        ...
        this.state = {
            ...
            confirmed: this.props.confirmed_applicant,
            places : this.props.participant_number-this.props.confirmed_applicant
        }
        ...
        return (
            ...
            <div className="row">
                      ...
                      <div className="col-md-6 mt-1">
                          ...
                          <div className="mt-1 mb-1 spec-1"><span></span><span className="dot"></span><span>{this.state.datetime}</span><span className='dot'></span><span>{this.state.duration} hour</span></div>
                      ...
                      <div className="align-items-center align-content-center col-md-3 border-left mt-1">
                          ...
                          <div className="d-flex flex-row align-items-center">
                              <h6 className="mr-1">{this.state.places} places remaining</h6>
                          </div>
